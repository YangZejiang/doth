...
def main():
    ...
    #     # borrowable_eth -> borrowable_dai * 70%

    print(f"You are going to borrow {amount_dai_to_borrow} DAI")

    #     dai_address = config["networks"][network.show_active()]["dai_token"]

    #     # def borrow_eth(lending_pool, amount_dai_to_borrow, account, dai_address=None):
    #     #     dai_address = (
    #     #         dai_address
    #     #         if dai_address
    ...
    #     # borrowable_eth, total_debt = get_borrowable_data(lending_pool, account)
    #     # amount_dai_to_borrow = (1 / borrowable_eth) * (total_debt * 0.7)
